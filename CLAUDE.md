...
| `rr3_templates` | Per-property HTML template for the ร.ร.๓ lodger registration card (`<<Token>>` placeholders), edited at Admin > RR3 Templates |
