...
import ImageCropperModal, { compressImage, readAspectRatioOk } from "@/lib/osh/ImageCropperModal";
import { Toast, useToast } from "@/lib/osh/Toast";
import { apiJson, useAllowedOshProperties, useOshSettings, useOshUser } from "@/lib/osh/oshClient";
import SetupBanner from "@/lib/osh/SetupBanner";

/**
 * OSH (sidebar) - the inspection itself, at /osh-checklist. A port of the
 * prototype's OSHForm/ChecklistRow, same fields, same rules, same messages.
 * This IS the OSH main menu now (renamed from "OSH Checklist" and flattened
 * 24-Sep-2026 at the user's request) - Report and Setting moved out to
 * Admin Console > OSH (src/app/admin/osh/report, .../settings), since
 * neither belongs on a form-filling terminal's own menu the way this page
 * does. What changed underneath from the original prototype:
 *
