  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-2xl text-gray-300">Your check-in is complete. Enjoy your stay!</p>
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 text-lg text-gray-300">
          <div className="flex items-center gap-3">
            <ExternalLink size={24} className="text-[var(--color-brand)]" />
            Please take your room key from the dispenser below.
          </div>
          <div className="flex items-center gap-3">
            <RefreshCw size={24} className="text-[var(--color-brand)]" />
