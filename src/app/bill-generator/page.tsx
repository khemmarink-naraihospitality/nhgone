            ...
            <div className="flex flex-col gap-2 w-full md:w-80">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-[42px] bg-[var(--paper)] border border-[var(--text-primary)]/14 px-4 pr-10 text-[13px] appearance-none cursor-pointer text-[var(--text-primary)] focus:border-[var(--text-primary)] outline-none"
                >
                  {properties.map((p) => (
