        ...
        <nav className="flex flex-col gap-1">
          {pathname.startsWith("/admin") ? (
            <>
              ...
              <Link href="/admin/billing-templates" className={`px-4 py-2 border-l-2 transition-all text-[12px] tracked-caps ${pathname === "/admin/billing-templates" ? "text-white font-bold bg-[#FFEFD2]/10 border-[#FFEFD2]" : "text-white/40 border-transparent hover:text-white"}`}>Billing Templates</Link>
              <Link href="/admin/rr3-templates" className={`px-4 py-2 border-l-2 transition-all text-[12px] tracked-caps ${pathname === "/admin/rr3-templates" ? "text-white font-bold bg-[#FFEFD2]/10 border-[#FFEFD2]" : "text-white/40 border-transparent hover:text-white"}`}>RR3 Templates</Link>
